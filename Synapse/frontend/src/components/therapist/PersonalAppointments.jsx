        ...
        <>
          ...
          <div className="flex justify-between items-center mt-6">
            <button
              ...
              className={`px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-300 ${currentPage === 0 ? "opacity-50 cursor-not-allowed" : ""
                }`}
            >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md bg-gray-200 hover:bg-gray-300 ${currentPage >= Math.ceil(appointments.length / itemsPerPage) - 1
